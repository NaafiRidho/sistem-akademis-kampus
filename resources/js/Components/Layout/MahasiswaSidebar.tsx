...
export default function MahasiswaSidebar({ sidebarOpen, setSidebarOpen, activeMenu = 'dashboard' }: SidebarProps) {
    const menuItems = [
        {
            name: 'Dashboard',
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="flex items-center justify-center mb-6 p-4 flex-shrink-0">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="text-xl font-bold text-gray-800 dark:text-white">Portal Mahasiswa</span>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
                        <form action="/logout" method="POST">
                            <button
                                type="submit"
                                className="flex items-center w-full p-3 text-gray-900 dark:text-white hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg group"
                            >
                                <svg
                                ...
                                <span className="ml-3 group-hover:text-red-600 dark:group-hover:text-red-400">Logout</span>
                            </button>
                        </form>
                    </div>
                </div>
