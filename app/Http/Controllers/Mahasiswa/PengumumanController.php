...
{
    /**
     * Display a listing of pengumuman for mahasiswa
     */
    public function index(Request $request)
    {
        ...
        $unreadCount = Pengumuman::whereIn('target_role', ['Mahasiswa', 'Semua'])
            ->whereDoesntHave('readers', function($q) use ($user) {
                $q->where('user_id', $user->id);
            })
            ->count();

        return Inertia::render('Mahasiswa/Pengumuman/Index', [
    ...
    public function show(string $id)
    {
        ...
        return Inertia::render('Mahasiswa/Pengumuman/Show', [
            'pengumuman' => $pengumuman
        ]);
    }
